...
export default function Gallery() {
  return (
    <section className='relative w-full text-senary ' id='gallery'>
      <div className='mt-[28rem] md:py-12 md:my-0'>
        <div className='text-center'>
          <h2 className='text-primary text-2xl md:text-6xl font-bold'>
            GALLERY
          </h2>
          <hr className='border-octonary border-t-2 md:border-t-4' />
        ...
        <div className='w-full items-center px-8'>
          ...
          >
            {galleries.map((gallery, index) => (
              <SwiperSlide
                key={index}
                className='relative flex flex-col items-center shadow-three rounded-3xl'
              >
                <Image
                  src={gallery.image}
                  alt={gallery.title}
